...
export const CompanyDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.company.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
